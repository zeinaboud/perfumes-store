...
// Compute full image URL using BASE_URL (for GitHub Pages)
const imageUrl = computed(() => {
  return product.value ? import.meta.env.BASE_URL + product.value.image : '';
});
    ...
    <div v-if="product">
        <div class=" max-w-7xl  mw-auto flex  flex-col lg:flex-row  gap-10">
            <div class="text-center lg:w-1/2">
                <img :src="imageUrl" :alt="product.name" class="mx-auto mt-6  sm:px-6 lg:gap-8 lg:px-8">
            </div>
            <div class="w-full lg:w-1/2 flex flex-col md:mt-8">
                <div class="flex items-center mb-2">
                    <Icon v-for="i in 5" 
                    :key="i" 
                    icon="line-md:star-alt-filled" width="16" height="16" 
